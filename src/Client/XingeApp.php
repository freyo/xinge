...
class XingeApp
{
    ...
    {
        if ((float) $this->accessId >= XingeApp::IOS_MIN_ID and $message instanceof MessageIOS)
            return true;
        else if ((float) $this->accessId < XingeApp::IOS_MIN_ID and $message instanceof Message)
            return true;
        else
            return false;
    }
